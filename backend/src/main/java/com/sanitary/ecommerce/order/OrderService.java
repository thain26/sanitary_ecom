...
public class OrderService {
    ...
    public OrderService(OrderRepository orderRepository, ProductRepository productRepository,
            FlashSaleProductRepository flashSaleProductRepository, PaymentRepository paymentRepository) {
    ...
    public Order createOrder(CheckoutRequest request) {
        ...
        payment.setStatus(savedOrder.getPaymentStatus().equals("PAID") ? "PAID" : "PENDING");
